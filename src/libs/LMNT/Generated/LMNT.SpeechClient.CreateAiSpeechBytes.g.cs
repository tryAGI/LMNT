...
namespace LMNT
{
    public partial class SpeechClient
    {
        ...
        private static readonly global::LMNT.EndPointSecurityRequirement s_CreateAiSpeechBytesSecurityRequirement0 =
        ...
        private static readonly global::LMNT.EndPointSecurityRequirement[] s_CreateAiSpeechBytesSecurityRequirements =
            new global::LMNT.EndPointSecurityRequirement[]
            {                s_CreateAiSpeechBytesSecurityRequirement0,
            };
        partial void PrepareCreateAiSpeechBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::LMNT.StreamSpeechRequest request);
        partial void PrepareCreateAiSpeechBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::LMNT.StreamSpeechRequest request);
        partial void ProcessCreateAiSpeechBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateAiSpeechBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        /// console.log(content);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<byte[]> CreateAiSpeechBytesAsync(

            global::LMNT.StreamSpeechRequest request,
            global::LMNT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateAiSpeechBytesAsResponseAsync(
        ...
        /// console.log(content);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> CreateAiSpeechBytesAsStreamAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAiSpeechBytesArguments(
            ...
            var __authorizations = global::LMNT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateAiSpeechBytesSecurityRequirements,
                operationName: "CreateAiSpeechBytesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateAiSpeechBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LMNT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LMNT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createAiSpeechBytes",
                                methodName: "CreateAiSpeechBytesAsync",
                                pathTemplate: "\"/v1/ai/speech/bytes\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateAiSpeechBytesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::LMNT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::LMNT.CreateAiSpeechBytesResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::LMNT.CreateAiSpeechBytesResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LMNT.ApiException<global::LMNT.CreateAiSpeechBytesResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::LMNT.CreateAiSpeechBytesResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::LMNT.CreateAiSpeechBytesResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LMNT.ApiException<global::LMNT.CreateAiSpeechBytesResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            try
                            {
                                ...
                                return new global::LMNT.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
                                ...
                                throw global::LMNT.ApiException.Create(
                                    statusCode: __response.StatusCode,
        ...
        /// console.log(content);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::LMNT.AutoSDKHttpResponse<byte[]>> CreateAiSpeechBytesAsResponseAsync(
                ...
                else
                {
                    await global::LMNT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateAiSpeechBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                ...
                                try
                                {
                                    ...
                                    return new global::LMNT.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> CreateAiSpeechBytesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LMNT.StreamSpeechRequest
            {
                Voice = voice,
                Text = text,
                Model = model,
            ...
            return await CreateAiSpeechBytesAsync(
                request: __request,
                requestOptions: requestOptions,
