...
namespace LMNT
{
    public partial interface IVoiceClient
    {
        ...
        /// console.log(voices);
        /// </remarks>
        global::System.Threading.Tasks.Task<global::LMNT.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::LMNT.Voice>>> GetAiVoiceListAsResponseAsync(
            string? starred = default,
            string? owner = default,
            global::LMNT.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
