...
namespace LMNT
{
    public partial class LmntClient
    {


        private static readonly global::LMNT.EndPointSecurityRequirement s_GetAccountSecurityRequirement0 =
        ...
        private static readonly global::LMNT.EndPointSecurityRequirement[] s_GetAccountSecurityRequirements =
            new global::LMNT.EndPointSecurityRequirement[]
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::LMNT.GetAccountResponse> GetAccountAsync(
                ...
                else
                {
                    await global::LMNT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::LMNT.GetAccountResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::LMNT.GetAccountResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LMNT.ApiException<global::LMNT.GetAccountResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::LMNT.GetAccountResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::LMNT.GetAccountResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LMNT.ApiException<global::LMNT.GetAccountResponse3>.Create(
                                    statusCode: __response.StatusCode,
