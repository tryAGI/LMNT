...
namespace LMNT
{
    public partial class VoiceClient
    {
        ...
        private static readonly global::LMNT.EndPointSecurityRequirement s_PutAiVoiceByIdSecurityRequirement0 =
        ...
        private static readonly global::LMNT.EndPointSecurityRequirement[] s_PutAiVoiceByIdSecurityRequirements =
            new global::LMNT.EndPointSecurityRequirement[]
            {                s_PutAiVoiceByIdSecurityRequirement0,
            };
        partial void PreparePutAiVoiceByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::LMNT.PutAiVoiceRequest request);
        partial void PreparePutAiVoiceByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::LMNT.PutAiVoiceRequest request);
        partial void ProcessPutAiVoiceByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPutAiVoiceByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::LMNT.PutAiVoiceResponse> PutAiVoiceByIdAsync(
            string id,
        ...
        {
            var __response = await PutAiVoiceByIdAsResponseAsync(
                id: id,
        ...
        /// console.log(voice.voice);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::LMNT.AutoSDKHttpResponse<global::LMNT.PutAiVoiceResponse>> PutAiVoiceByIdAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePutAiVoiceByIdArguments(
            ...
            var __authorizations = global::LMNT.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PutAiVoiceByIdSecurityRequirements,
                operationName: "PutAiVoiceByIdAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::LMNT.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::LMNT.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "putAiVoiceById",
                                methodName: "PutAiVoiceByIdAsync",
                ...
                else
                {
                    await global::LMNT.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::LMNT.PutAiVoiceResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::LMNT.PutAiVoiceResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LMNT.ApiException<global::LMNT.PutAiVoiceResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::LMNT.PutAiVoiceResponse3? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::LMNT.PutAiVoiceResponse3.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::LMNT.ApiException<global::LMNT.PutAiVoiceResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPutAiVoiceByIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::LMNT.PutAiVoiceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::LMNT.AutoSDKHttpResponse<global::LMNT.PutAiVoiceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::LMNT.PutAiVoiceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::LMNT.PutAiVoiceResponse> PutAiVoiceByIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::LMNT.PutAiVoiceRequest
            {
            ...
            return await PutAiVoiceByIdAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
